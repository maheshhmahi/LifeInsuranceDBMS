        ...
        <div class="container">
            <div class="banner-text">
                <div class="slider-info">
                    ...
                    <p class="text-white mt-sm-4 mt-2"></p>
                    <p class="text-white mt-sm-4 mt-2"></p>
                    <a class="btn btn-primary mt-4 agile-link-bnr scroll" href="#shruu" role="button">View
                        More</a>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 my-lg-0 my-md-5">
                                <div class="abt-block">
                                    ...
                                    <p>The excess of premium payments above the current cost of insurance is credited to the cash value of the policy, which is credited each month with interest.
                                    </p>
                                </div>
                            </div>
                            <div class="col-lg-6 mt-lg-0 mt-5">
                                <div class="abt-block">
                                    ...
                                    <p>The insurance promises payment of a specified death benefit within a specific period of years.
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="py-lg-5 w3-abbottom">
                <div class="row py-5">
                    <div class="counter col-lg-3 col-6">
                        ...
                        <div class="timer count-title count-number mt-2 text-white" data-to="2500" data-speed="1500"></div>
                        <p class="count-text text-capitalize text-white">happy clients</p>
                    </div>

                    <div class="counter col-lg-3 col-6">
                        <i class="fas fa-database"></i>
                        <div class="timer count-title count-number mt-2 text-white" data-to="171" data-speed="1500"></div>
