...
<form action="client_ins.php" method="post" style="max-width:500px; margin:auto">
  <!---<div class="input-container">
   <input class="input-field" type="number" name="ID" placeholder="Your ID" value="<?php echo $cid; ?>">--->
    ...
    <div class="input-container">
    <input class="input-field" type="number" name="Phone" placeholder="Phone" required>
    </div>
    <!---<div class="input-container">
    ...
    <div class="input-container">
    <input class="input-field" type="text" name="policy_name" placeholder="policy name" value="term" required>
    </div>
